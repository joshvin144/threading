...
def main(arg = None, argv = None):
	...
	receiver_1_thread = threading.Thread(target = receiver_1_worker)
	receiver_2_thread = threading.Thread(target = receiver_2_worker)

	# Extracting information from a thread takes a significant amount of time
	# receiver_1_thread = threading.Thread(target = receiver_1_worker, args = (results_dict,))
	# receiver_2_thread = threading.Thread(target = receiver_2_worker, args = (results_dict,))
